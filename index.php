...
<html>
<head>
	<title>Welcome on My Daily Song</title>
	...
	<meta name="subject" content="Home page of My Daily Song">
	...
	<div class="container-fluid">
		...
		<header class="page-header">
			<div class="page-header-nav">
				...
				<div class="row">
					<div class="col-12">
						<h1 class="display-1"> <img src="assets/img/logos/logo.png"> Welcome on My Daily Song</h1>
			...
			<div class="row justify-content-center">
				<div class="col-12 col-md-10">
					...
					<div class="sm-content">
						<p class="sm-p-cover hidden-md-down"><img src="assets/img/sm.jpg" class="sm-cover"></p>
						<p>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
